...
<div class="site-container">
	<div id="st-container" class="st-container">
        ...
        <!--[if IE]><div class="st-pusher <?php if (get_theme_mod( 'menu_position','right') == 'right') { ?>right<?php } else { ?>left<?php } ?> st-pusher-ie"><![endif]-->
            <div class="st-content"><!-- this is the wrapper for the content -->
                <div class="st-content-inner entry-content"><!-- extra div for emulating position:fixed of the menu -->
                    <div class="video-shade"></div>
                        <div class="po-portfolio-slider-top <?php if ( 'black-content' == get_theme_mod( 'category_image_content') ) { ?>black-content<?php } else if ( 'light-content' == get_theme_mod( 'category_image_content') ) { ?>light-content<?php } else { ?>white-content<?php } ?>">
            ...
            <div class="po-column top-logo-outer" data-delay="2200" data-animation="move-down-short">
                                        <div class="top-logo-container">
                                            <a href="<?php echo esc_url(get_home_url()); ?>">
                                                <?php if ( 'black-content' == get_theme_mod( 'category_image_content') ) { ?>
                                                ...
                                                <?php } else if ( 'light-content' == get_theme_mod( 'category_image_content') ) { ?>
            ...
            <div id="ededede" class="po-section section-image section-background-image-parallax <?php if ( 'black-content' == get_theme_mod( 'category_image_content') ) { ?>black-content<?php } else if ( 'white-content' == get_theme_mod( 'category_image_content') ) { ?>white-content<?php } else { ?>light-content<?php } ?>" style="background: url(<?php echo esc_url(get_theme_mod( 'category_image_upload')); ?>) #111;" data-center="background-position: 50% 0px;"
        data-bottom-top="background-position: 50% 150px;"
        data-top-bottom="background-position: 50% -150px;"
        data-anchor-target="#ededede">
			<!--[if IE 8]><img class="section-bg-ie" src="<?php echo esc_url(get_theme_mod( 'category_image_upload')); ?>" alt="background"><![endif]-->
            <div class="slider-image-inner-page">
                                        <div class="po-slider-bottom-button po-slider-bottom-button-page po-column" data-delay="2700" data-animation="move-up-short">
                                            ...
                                            <div class="po-column slider-caption" data-delay="1700" data-animation="move-up-short"> 
                                                <h1 class="text-center"><?php printf( __( 'Category: %s', 'twentyfourteen' ), single_cat_title( '', false ) ); ?></h1>
                                            </div>

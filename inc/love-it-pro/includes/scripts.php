...
function lip_front_end_js() {
	wp_enqueue_script('love-it', get_template_directory_uri() . '/inc/love-it-pro/includes/js/love-it.js', array( 'jquery' ), NULL, TRUE );
	if(!is_user_logged_in()) {
		wp_enqueue_script( 'jquery-coookies', get_template_directory_uri() . '/inc/love-it-pro/includes/js/jquery.cookie.js', array( 'jquery' ), NULL, TRUE );
	}

        ...
        <!--[if IE]><div class="st-pusher <?php if (get_theme_mod( 'menu_position','right') == 'right') { ?>right<?php } else { ?>left<?php } ?> st-pusher-ie"><![endif]-->
            <div class="st-content"><!-- this is the wrapper for the content -->
                <div class="st-content-inner entry-content" ><!-- extra div for emulating position:fixed of the menu -->
                    ...
                    <?php if ( 'image' == $page_mb->get_the_value( 'header_style' ) ) { ?>
                    	...
                    	<div class=""><img class="img-responsive" src="http://themes:8888/giza/wp-content/uploads/2014/08/scenery2_mini.jpg" alt=""/></div>
                    <?php } else { ?>
                   ...
                   <div class="col-sm-12 col-md-9"> 
                        	...
                        	<div class="entry-content">
								<div class="po-blog">
									...
									$terms = get_the_term_list( $post->ID, 'category', '', ' / ', '' );
                                    ?>
                                        <div class="po-column col-sm-6 col-lg-6 <?php if ( 'minimal' == $page_mb->get_the_value( 'post_style' ) ) { ?>blog-item<?php } else { ?>blog-item-standard<?php } ?>" style="margin-bottom:80px;" data-delay="<?php echo esc_attr($format_mb->get_the_value('delay')); ?>" data-animation="move-up-short">
                                        <?php

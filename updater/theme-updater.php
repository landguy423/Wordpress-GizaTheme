...
$updater = new EDD_Theme_Updater_Admin(
	...
	// Config settings
	$config = array(
		'remote_api_url' => 'http://pixelobject.com', // Site where EDD is hosted
		'item_name' => 'Giza', // Name of theme
		'theme_slug' => 'giza', // Theme slug
		'version' => '1.2.1', // The current version of this theme
		'author' => 'Pixelobject', // The author of this theme
		'download_id' => '4387', // Optional, used for generating a license renewal link
		'renew_url' => '' // Optional, allows for a custom license renewal link
	),

	// Strings
	$strings = array(
		'theme-license' => __( 'Giza License', 'edd-theme-updater' ),

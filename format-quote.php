	...
	<div class="no-padding grid blog-item-cont">
                    ...
                    <![endif]-->
                        ...
                        <![endif]-->
                            ...
                            <div class="blog-read"><span style="float:left;">Read quote</span> <span style="float:right;"><i  style="margin-left:20px;" class="fa fa-chevron-right"></i></span><div class="clearfix"></div></div>
...
<![endif]-->
	...
	<div class="no-padding grid blog-item-cont" href="<?php the_permalink(); ?>">
                    ...
                    <!--[if !IE 8]><!-->
                    	<figure class="effect-chico standard standard-height" style="background:#fff; border:1px solid #e5e5e5;">
                        
                    <!--<![endif]-->
                    <!--[if IE 8]>
                    	<div class="figure-ie effect-chico standard standard-height" style="background:#fff; border:1px solid #e5e5e5;">
                    <![endif]-->
                            
							<div class="" data-bg="<?php echo esc_url($url); ?>" style="width:100%; height:200px;
                            background-size:cover; background-position:center;">
                            			<a href="<?php the_permalink(); ?>">
										<div class="blog-read-standard"><span style="float:left;">Read quote</span> <span style="float:right;"><i  style="margin-left:20px;" class="fa fa-chevron-right"></i></span><div class="clearfix"></div></div>
                                    	</a>

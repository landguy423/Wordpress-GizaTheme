...
var speed = 1000;
    ...
    $('.site-container').delay(500).animate({opacity:1}, speed, function() {
        $('.menu a, .go-to-click, .bottom-nav a, .bottom-nav-short a, button[href], .po-slider-folder-button a, .port-details a, .portfolio-item a, .pagination li a, .po-port-nav a, .liquid-container-page a, .portfolio-item-effect-2 a, .archive-btn a, .team-item a, .blog-item-cont a, .blog-item-cont-gallery a, .po-page-header a, .entry-title a, .widget-area a, .bottom-logo-container, .top-logo-container a, .st-menu-inner a, .po-page-portfolio-paginate a').click(function(event) {

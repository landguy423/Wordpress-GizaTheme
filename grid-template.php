				...
				?>
                        	<div class="entry-content">
								<div class="po-blog">
									...
									$terms = get_the_term_list( $post->ID, 'category', '', ' / ', '' );
                                    ?>
                                        <div class="po-column col-sm-6 col-lg-4 <?php if ( 'minimal' == $page_mb->get_the_value( 'post_style' ) ) { ?>blog-item<?php } else { ?>blog-item-standard<?php } ?>" style="margin-bottom:80px;" data-delay="<?php echo esc_attr($format_mb->get_the_value('delay')); ?>" data-animation="move-up-short">
                                        <?php
